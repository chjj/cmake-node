...
if(APPLE)
  ...
  list(APPEND _node_cflags -D_DARWIN_USE_64_BIT_INODE=1)
endif()

if(NOT WIN32)
  list(APPEND _node_cflags -D_LARGEFILE_SOURCE)
  list(APPEND _node_cflags -D_FILE_OFFSET_BITS=64)
endif()
...
if(CMAKE_HOST_SYSTEM_NAME STREQUAL "OS390")
  ...
  list(APPEND _node_cflags -D_ALL_SOURCE=1)
